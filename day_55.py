# Penggunaan library OS

# Example menampilkan semua data termasuk hidden
# yang ada dalam sebuah file
""" import os
...
os.rename("myname.txt", "newName.txt") """

# Project

# Membuat inputan file dan berkas cadangan pada
# file baru
...
while True:
    ...
    if fileExists:
        ...
        # Dalam hal ini, perintah cp digunakan 
